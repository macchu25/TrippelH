      ...
      <div className="flex gap-4 pb-5">
        ...
        >
          <div className="h-full flex flex-col items-center justify-center p-4">
            <div className=" size-10 bg-indigo-200 rounded-full flex items-center justify-center mb-3">
        ...
        {stories &&
          stories.map((story, index) => (
            <div
              ...
              key={index}
              className={`relative rounded-lg shadow-sm min-w-30 max-w-30 max-h-40 cursor-pointer hover:shadow-lg transition-all duration-200 bg-gradient-to-b from-indigo-500 to bg-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95`}
            >
              {/* truncate: Cuts off overflowed text with ... if it doesn’t fit in the container. */}
              <img
