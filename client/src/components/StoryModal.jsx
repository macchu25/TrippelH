  ...
  return (
    <div className="fixed inset-0 z-110 min-h-screen bg-black/80 backdrop:blur text-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <button className=" cursor-pointer flex items-center justify-center gap-2 text-white py-3 mt-4 w-full rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition" onClick={handleCreateStory}>
