...
const ProfileModal = ({ setShowEdit }) => {
  ...
  return (
    <div className="fixed top-0 bottom-0 left-0 right-0 z-110 h-screen overflow-y-scroll bg-black/50">
      <div className="max-w-2xl sm:py-2 mx-auto">
              ...
              >
                ...
                <div className="group/profile relative">
                  <img
                    ...
                    alt="Profile Preview"
                    className="w-24 h-2/4 rounded-full object-cover mt-2"
                  />
              ...
              >
                ...
                <div className="group/cover relative">
                  <img
                    ...
                    alt="Cover Preview"
                    className="w-80 h-40 rounded-lg bg-gradient-to-r from-indigo-300 via-purple-200 to-pink-200  object-cover mt-2"
                  />
